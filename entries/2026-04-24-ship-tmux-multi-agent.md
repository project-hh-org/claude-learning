...
이 글에서 다룬 핵심 개념: [[tmux-wave-pattern]], [[claude-code-hooks]]

Claude Code 환경 전체 설정은 [[2026-05-05-claude-code-setup-and-hooks|Claude Code 환경 최적화]] 참고.
`ship` 스크립트 자체의 배포는 [[2026-04-24-symlink-single-source|심볼릭 링크 패턴]]으로 관리한다.
